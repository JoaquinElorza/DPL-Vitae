...
@section('title', 'Editar Padecimiento')
@section('header', 'PADECIMIENTOS')

@section('content')
    <div class="mb-6 flex justify-between items-center">
        <h3 class="text-2xl font-semibold">Editar padecimiento</h3>
    ...
    <div class="bg-white rounded-2xl shadow-md p-8 max-w-2xl">
        <form action="{{ route('padecimientos.update', $padecimiento->id_padecimiento) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    value="{{ old('nombre_padecimiento', $padecimiento->nombre_padecimiento) }}"
            ...
            <div class="mb-5">
                ...
                >
                    ...
                    @foreach(['Bajo', 'Medio', 'Alto', 'Crítico'] as $nivel)
                        <option value="{{ $nivel }}"
                            {{ old('nivel_riesgo', $padecimiento->nivel_riesgo) == $nivel ? 'selected' : '' }}>
                            {{ $nivel }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-8">
                ...
                <input
                    ...
                    id="costo_extra"
                    name="costo_extra"
                    value="{{ old('costo_extra', $padecimiento->costo_extra) }}"
                    class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#d90000] focus:border-transparent"
                    placeholder="0.00"
                    step="0.01"
                    min="0"
