            ...
            <form action="{{ route('padecimientos.store') }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre_padecimiento" class="form-control @error('nombre_padecimiento') is-invalid @enderror" value="{{ old('nombre_padecimiento') }}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="nivel_riesgo" class="form-control @error('nivel_riesgo') is-invalid @enderror" value="{{ old('nivel_riesgo') }}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" name="costo_extra" class="form-control @error('costo_extra') is-invalid @enderror" value="{{ old('costo_extra') }}" required>
